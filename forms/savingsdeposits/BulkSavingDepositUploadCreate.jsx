...
function BulkSavingDepositUpload({ onBatchSuccess }) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 py-4">
            ...
            <div className="bg-emerald-50 rounded-2xl p-6 border border-emerald-100 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                <div className="flex items-center gap-4">
                    <div className="bg-white p-3 rounded-xl shadow-sm border border-emerald-50">
                        <Download className="w-6 h-6 text-emerald-600" />
                    </div>
                    <div>
                        <p className="text-sm font-black text-slate-800 uppercase tracking-tighter">Deposit Template</p>
                ...
                <Button 
                    ...
                    className="border-emerald-600 text-emerald-600 hover:bg-emerald-600 hover:text-white font-bold px-6 h-10 transition-all rounded-xl"
                >
                    Get Template
                </Button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                    ...
                    {file ? (
                        <div className="flex flex-col items-center space-y-4 animate-in fade-in zoom-in-95">
                            <div className="p-5 bg-emerald-600 rounded-full text-white shadow-lg ring-4 ring-emerald-50">
                        ...
                        <div className="flex flex-col items-center space-y-5">
                            <div className="p-6 bg-slate-50 rounded-full text-emerald-300 border-2 border-white shadow-md">
                ...
                <div className="flex justify-center pt-2">
                    <Button
                        type="submit"
                        className="bg-emerald-600 hover:bg-emerald-700 text-white px-20 h-14 rounded-2xl font-black text-lg shadow-xl shadow-emerald-100 transition-all active:scale-95 disabled:opacity-30 uppercase tracking-tight"
