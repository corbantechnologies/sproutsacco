...
function BulkLoanDisbursementUpload({ onBatchSuccess }) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 py-4">
            ...
            <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                <div className="flex items-center gap-4">
                    <div className="bg-white p-3 rounded-xl shadow-sm border border-blue-50">
                        <Download className="w-6 h-6 text-blue-600" />
                    </div>
                    <div>
                        <p className="text-sm font-black text-slate-800 uppercase tracking-tighter">Disbursement Template</p>
                ...
                <Button 
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white font-bold px-6 h-10 shadow-md shadow-blue-100 transition-all rounded-xl"
                >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                    ...
                    {file ? (
                        <div className="flex flex-col items-center space-y-4 animate-in fade-in zoom-in-95">
                            <div className="p-5 bg-blue-600 rounded-full text-white shadow-lg ring-4 ring-blue-50">
                                <FileCheck className="w-10 h-10" />
                            </div>
                            <div className="space-y-1">
                                <p className="font-extrabold text-xl text-slate-900 tracking-tight">{file.name}</p>
                                <p className="text-[12px] text-blue-600 font-black uppercase tracking-[0.2em]">
                            ...
                            <Button
                                ...
                                className="text-rose-600 hover:text-rose-700 hover:bg-rose-50 font-bold h-9 mt-4 px-6 rounded-full"
                            >
                        ...
                        <div className="flex flex-col items-center space-y-5">
                            <div className="p-6 bg-slate-50 rounded-full text-blue-300 border-2 border-white shadow-md">
                ...
                <div className="flex justify-center pt-2">
                    <Button
                        type="submit"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-20 h-14 rounded-2xl font-black text-lg shadow-xl shadow-blue-100 transition-all active:scale-95 disabled:opacity-30 uppercase tracking-tight"
