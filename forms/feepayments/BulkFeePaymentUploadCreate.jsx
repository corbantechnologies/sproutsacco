...
function BulkFeePaymentUpload({ onBatchSuccess }) {
    ...
    return (
        <div className="max-w-3xl mx-auto space-y-8 py-4">
            ...
            <div className="bg-amber-50 rounded-2xl p-6 border border-amber-100 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
                <div className="flex items-center gap-4">
                    <div className="bg-white p-3 rounded-xl shadow-sm border border-amber-50">
                        <Download className="w-6 h-6 text-amber-600" />
                    </div>
                    <div>
                        <p className="text-sm font-black text-slate-800 uppercase tracking-tighter">Collection Template</p>
                ...
                <Button 
                    ...
                    className="border-amber-600 text-amber-600 hover:bg-amber-600 hover:text-white font-bold px-6 h-10 transition-all rounded-xl"
                >
                    Get Template
                </Button>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                >
                    ...
                    {file ? (
                        <div className="flex flex-col items-center space-y-4 animate-in fade-in zoom-in-95">
                            <div className="p-5 bg-amber-600 rounded-full text-white shadow-xl ring-4 ring-amber-50">
                                <FileCheck className="w-10 h-10" />
                            </div>
                            <div className="space-y-1">
                                <p className="font-extrabold text-xl text-slate-900 tracking-tight">{file.name}</p>
                                <p className="text-[12px] text-amber-600 font-black uppercase tracking-[0.2em]">
                            ...
                            <Button
                                ...
                                className="text-amber-700 hover:text-amber-800 hover:bg-amber-50 font-bold h-9 mt-4 px-6 rounded-full"
                            >
                        ...
                        <div className="flex flex-col items-center space-y-6">
                            <div className="p-6 bg-amber-50 rounded-full text-amber-200 border-2 border-white shadow-md">
                ...
                <div className="flex justify-center pt-2">
                    <Button
                        type="submit"
                        className="bg-amber-600 hover:bg-amber-700 text-white px-24 h-14 rounded-2xl font-black text-lg shadow-xl shadow-amber-200 transition-all active:scale-95 disabled:opacity-30 uppercase tracking-tight"
